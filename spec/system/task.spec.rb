...
describe "タスク管理機能", type: :system do
  let!(:task_a) { FactoryBot.create(:task, name: '最初のタスク', detail: '最初の詳細')}
  let!(:task_b) { FactoryBot.create(:task, name: '二番目のタスク', detail: '二番目の詳細')}
  let!(:task_c) { FactoryBot.create(:task, name: '三番目のタスク', detail: '三番目の詳細')}
